...
class Client extends \App\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'prenom', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'adresse', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'ville', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'codePostale', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'typeClient'];
        }
     ...
     * {@inheritDoc}
     */
    public function setTypeClient(string $typeClient): \App\Entity\Client
    {
